...
export default function PortfolioDetailsTwentyArea() {
  const scrollTo = () => {
  ...
  return (
    <>
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="tp-project-details-3-title-box">
                      <h2 className="tp-section-title-160 mb-50 tp-char-animation">Speaking Tool</h2>
                  </div>
                </div>
            </div>
            <div className="row">
      ...
      <div className="tp-project-details-3-full-width-thumb mb-120">
          <Image data-speed=".8" src={full_image} alt="Speaking Tool" style={{ height: 'auto' }}/>
      </div>
      {/* full image */}
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="showcase-details-2-section-box">
                      <h4 className="showcase-details-2-section-title tp-char-animation">Voice Technology</h4>
                  </div>
                </div>
            </div>
            <div className="row">
                ...
                <div className="col-xl-9">
                  <div className="showcase-details-2-content-right tp_title_anim">
                      <p className="pb-25">Advanced speaking tool that leverages cutting-edge voice recognition and synthesis technology to enhance communication and presentation capabilities.</p>
                      <p>The product integrates real-time speech analysis, pronunciation feedback, and adaptive learning algorithms to help users improve their speaking skills and confidence.</p>
                  </div>
                </div>
            </div>
          </div>
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="tp-project-details-3-thumb-box">
                    <Image data-speed=".8" src={full_image_2} alt="Speaking Tool interface" style={{ height: 'auto' }}/>
                  </div>
                </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
              <div className="col-xl-8">
                <div className="showcase-details-2-section-box">
                    <h4 className="showcase-details-2-section-title tp-char-animation">User Experience</h4>
                </div>
              </div>
          </div>
          <div className="row">
              ...
              <div className="col-xl-9">
                <div className="showcase-details-2-content-right tp_title_anim">
                    <p className="pb-25">The speaking tool delivers personalized feedback and coaching, helping users develop clear articulation, proper pacing, and confident delivery in various speaking contexts.</p>
                    <p>Interactive features include voice exercises, progress tracking, and adaptive challenges that make speech improvement engaging and measurable for users of all skill levels.</p>
                </div>
              </div>
          </div>
        </div>
    ...
    {/* details area */}
     ...
     <div className="pd-visual-slider-wrap pb-40">
              ...
              {slider_images.map((imgSrc, index) => (
                <SwiperSlide key={index}>
                  <div className="pd-visual-slider-thumb fix">
                    <Image src={imgSrc} alt="Speaking Tool portfolio" style={{height:"auto"}}/>
                  </div>
                </SwiperSlide>
              ))}
          </Swiper>
      ...
      <PortfolioNavigation currentPath="/portfolio-details-20" />
      {/* portfolio navigation */}
    </>
  )
}
