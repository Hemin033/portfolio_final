...
export default function PortfolioDetailsTwelveArea() {
  const scrollTo = () => {
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="tp-project-details-3-title-box">
                      <h2 className="tp-section-title-160 mb-50 tp-char-animation">AI Product Development</h2>
                  </div>
                </div>
            </div>
            <div className="row">
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="showcase-details-2-section-box">
                      <h4 className="showcase-details-2-section-title tp-char-animation">Intelligent Solutions</h4>
                  </div>
                </div>
            </div>
            <div className="row">
                ...
                <div className="col-xl-9">
                  <div className="showcase-details-2-content-right tp_title_anim">
                      <p className="pb-25">This AI product represents the cutting edge of artificial intelligence technology, featuring advanced machine learning models and intuitive user interfaces that make complex AI accessible to everyone.</p>
                      <p>The product incorporates natural language processing, computer vision, and predictive analytics to deliver intelligent automation and decision-making capabilities.</p>
                  </div>
                </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
              <div className="col-xl-8">
                <div className="showcase-details-2-section-box">
                    <h4 className="showcase-details-2-section-title tp-char-animation">Market Innovation</h4>
                </div>
              </div>
          </div>
          <div className="row">
              ...
              <div className="col-xl-9">
                <div className="showcase-details-2-content-right tp_title_anim">
                    <p className="pb-25">The AI product successfully launched to market with overwhelming positive response, establishing new standards in the industry for intelligent automation.</p>
                    <p>Continuous learning algorithms and user feedback integration ensure the product evolves and improves with each interaction, delivering increasing value over time.</p>
                </div>
              </div>
          </div>
        </div>
