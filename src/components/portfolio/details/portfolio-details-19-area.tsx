...
export default function PortfolioDetailsNineteenArea() {
  const scrollTo = () => {
  ...
  return (
    <>
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="tp-project-details-3-title-box">
                      <h2 className="tp-section-title-160 mb-50 tp-char-animation">Custom ChatGPT</h2>
                  </div>
                </div>
            </div>
            <div className="row">
      ...
      <div className="tp-project-details-3-full-width-thumb mb-120">
          <Image data-speed=".8" src={full_image} alt="Custom ChatGPT" style={{ height: 'auto' }}/>
      </div>
      {/* full image */}
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="showcase-details-2-section-box">
                      <h4 className="showcase-details-2-section-title tp-char-animation">AI Product Development</h4>
                  </div>
                </div>
            </div>
            <div className="row">
                ...
                <div className="col-xl-9">
                  <div className="showcase-details-2-content-right tp_title_anim">
                      <p className="pb-25">Custom ChatGPT solution tailored for specific business needs, integrating advanced conversational AI capabilities with personalized training and deployment.</p>
                      <p>The product features custom knowledge bases, brand-specific responses, and seamless integration with existing workflows to enhance customer service and internal operations.</p>
                  </div>
                </div>
            </div>
          </div>
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="tp-project-details-3-thumb-box">
                    <Image data-speed=".8" src={full_image_2} alt="Custom ChatGPT interface" style={{ height: 'auto' }}/>
                  </div>
                </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
              <div className="col-xl-8">
                <div className="showcase-details-2-section-box">
                    <h4 className="showcase-details-2-section-title tp-char-animation">Product Impact</h4>
                </div>
              </div>
          </div>
          <div className="row">
              ...
              <div className="col-xl-9">
                <div className="showcase-details-2-content-right tp_title_anim">
                    <p className="pb-25">The custom ChatGPT implementation significantly improved customer response times and query resolution rates while maintaining consistent brand voice across all interactions.</p>
                    <p>Advanced training on company-specific data enabled the AI to provide accurate, contextual responses that enhanced user experience and reduced operational overhead.</p>
                </div>
              </div>
          </div>
        </div>
              ...
              {slider_images.map((imgSrc, index) => (
                <SwiperSlide key={index}>
                  <div className="pd-visual-slider-thumb fix">
                    <Image src={imgSrc} alt="Custom ChatGPT portfolio" style={{height:"auto"}}/>
                  </div>
                </SwiperSlide>
              ))}
          </Swiper>
