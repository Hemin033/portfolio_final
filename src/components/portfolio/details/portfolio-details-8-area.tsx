...
export default function PortfolioDetailsEightArea() {
  const scrollTo = () => {
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="tp-project-details-3-title-box">
                      <h2 className="tp-section-title-160 mb-50 tp-char-animation">AI-Powered Analytics</h2>
                  </div>
                </div>
            </div>
            <div className="row">
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="showcase-details-2-section-box">
                      <h4 className="showcase-details-2-section-title tp-char-animation">Machine Learning Integration</h4>
                  </div>
                </div>
            </div>
            <div className="row">
                ...
                <div className="col-xl-9">
                  <div className="showcase-details-2-content-right tp_title_anim">
                      <p className="pb-25">This AI-powered analytics platform leverages machine learning algorithms to provide deep insights and predictive analytics. The system processes complex datasets to deliver actionable intelligence.</p>
                      <p>Advanced neural networks and natural language processing capabilities enable automated report generation and intelligent data visualization.</p>
                  </div>
                </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
              <div className="col-xl-8">
                <div className="showcase-details-2-section-box">
                    <h4 className="showcase-details-2-section-title tp-char-animation">Smart Automation</h4>
                </div>
              </div>
          </div>
          <div className="row">
              ...
              <div className="col-xl-9">
                <div className="showcase-details-2-content-right tp_title_anim">
                    <p className="pb-25">The platform automates complex analytical processes, reducing manual work by 80% while improving accuracy and speed of insights generation.</p>
                    <p>Real-time data processing and adaptive learning algorithms ensure the system continuously improves its performance and accuracy over time.</p>
                </div>
              </div>
          </div>
        </div>
